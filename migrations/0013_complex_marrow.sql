...
INSERT INTO `__new_movies_table`("id", "externalDatabaseMovieId", "title", "overview", "backgroundImage", "posterImage", "runnningMinutes", "releaseYear", "cached_at") SELECT "id", "externalDatabaseMovieId", "title", "overview", "backgroundImage", "posterImage", "runnningMinutes", "releaseYear", "cached_at" FROM `movies_table`;--> statement-breakpoint
