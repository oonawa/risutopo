...
import PreviewListItem from "./index";

const movieWithDetails: ListItem = {
	listItemId: "preview-story-movie-with-details",
	title: "トータル・リコール",
...
const meta = {
	title: "app/components/ListItem/Preview/PreviewListItem",
...
} satisfies Meta<typeof PreviewListItem>;
